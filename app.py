...
mathjax = "https://cdn.jsdelivr.net/npm/mathjax@3.0.0/es5/tex-mml-chtml.js"
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.H6('Demo', className='boundary', style={
            'text-align': 'center', 'background-color': 'rgb(234, 229, 240)'}),

        html.Div([

            html.Div([
                html.Div([
                    html.P('Boundary drainage condition:',
                           style={'margin-top': '15'}),
                    dcc.Dropdown(
                        id='drainage',
                        options=[
                    ...
                    html.Br(),
                    html.Div([
                        html.P(r'Model height, \( H \) [m]:',
                               className='one-half column'),
                        html.P(
                            r'Initial pore pressure, \( u_o \) [kPa]:', className='one-half column')
                    ], className='row'),
                    dcc.Input(
                        id='height',
                        value=2,
            ...
            html.Div([
                html.P(
                    r'Coefficient of consolidation, \( c_v~[\mathrm{cm^2/s}] \):', style={'margin-top': '15'}),
                dcc.Slider(
                    id='cons-coeff',
                    min=-6,
                    max=1,
